...
Any form of plagiarism is strictly forbidden and will result in rehould be included in your header file called search_algos.h
...
Value checked array[1] = [1]
Value checked array[2] = [2]
Value checked array[4] that array will be sorted in ascending order
If value is not present in array or if array is NULL, your function must return -1
Every time you split the array, you have to print the new array (or subarray) you’re searching in (See example)
...
GitHub repository: alx-low_level_programming
Directory: 0x1E-search_algorithms
File: 108-Omoval from the program.
Requirements
General
...
The prototypes of all your functions s= [4]
Value checked array[8] = [18]
Value found between indexes [8] and [15]
Searching in array: 18, 19, 23, 54, 61, 62, 76, 99
Searching in array: 61, 62, 76, 99
